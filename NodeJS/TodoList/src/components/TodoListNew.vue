        ...
        <div class="container">
            <div class="row justify-content-center m-2">
                <div class="col border border-primary rounded">
                    <input type="text" id="todo_input" class="form-control my-2" v-model="job" placeholder="할일을 작성하세요"/>
                </div>
                <div class="row my-2">
                    <div class="col-6">
                    ...
                    <div class="col-6">
                        <button type="button" class="btn btn-primary btn-sm float-end" @click="onAddTodo">할일추가</button>
                    </div>
                </div>
            </div>
        </div>
